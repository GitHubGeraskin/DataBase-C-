...
{
    std::cout << "\t\t Command\n";
    std::cout << "\t\t Add (Adding a Date - Event pair) \n";
    std::cout << "\t\t Print (Output the database)\n";
    std::cout << "\t\t Del (Delete an item) \n";
    std::cout << "\t\t Find (Output everything by a specific date)\n";
    std::cout << "\t\t Last (Output a record with the last event that occurred no later than this date) \n";
    std::cout << "\t\t Info (Output commands for working with the database) \n";
}
int main()
{
    TestAll();
